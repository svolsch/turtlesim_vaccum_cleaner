...
class WallAvoidingTurtle:
    def __init__(self):
        ...
        self.velocity_publisher = rospy.Publisher('/turtle3/cmd_vel', Twist, queue_size=10)

        # self.pose_publisher_2 = rospy.Publisher('/turtle2/pose', Pose, queue_size = 10)
        # self.pose_publisher_4 = rospy.Publisher('/turtle4/pose', Pose, queue_size = 10)
        # self.pose_publisher_1 = rospy.Publisher('/turtle1/pose', Pose, queue_size = 10)
        
        self.pose_subscriber = rospy.Subscriber('/turtle3/pose', Pose, self.update_pose)
    ...
    def set_pen_color(self, r, g, b):
        ...
        try:
            pen_service = rospy.ServiceProxy('turtle3/set_pen', SetPen)
